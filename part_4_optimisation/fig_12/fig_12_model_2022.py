...
class BESSWorkflowController:
    ...
    def calculate_dam_profits(self, power_mw, energy_mwh):
        ...
        csv_file = f'{self.base_path}/cleaned_market_prices/dam_and_idm/2022_dam_idm_price.csv'
    ...
    def run_baseline_stage(self, power_mw, energy_mwh, risk_aversion=3):
        ...
        idm_file = f'{self.base_path}/cleaned_market_prices/dam_and_idm/2022_dam_idm_price.csv'
        ...
        dch_file = os.path.join(dc_path, 'DCH/2022_dch_price.csv')
        dcl_file = os.path.join(dc_path, 'DCL/2022_dcl_price.csv')
    ...
    def run_all_configurations(self):
        """Run baseline workflow for all 17 BESS configurations across multiple risk aversion values using 2022 data"""
        print("Starting BESS Portfolio Optimization Workflow - 2022 Baseline")
        print("=" * 50)
        ...
        if all_results:
            ...
            output_file = os.path.join(output_dir, 'figure_12_2022.csv')
