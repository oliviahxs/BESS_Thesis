...
class BESSWorkflowController:
    ...
    def calculate_dam_profits(self, power_mw, energy_mwh):
        ...
        csv_file = f'{self.base_path}/cleaned_market_prices/dam_and_idm/2023_dam_idm_price.csv'
    ...
    def run_baseline_stage(self, power_mw, energy_mwh, risk_aversion=3):
        ...
        idm_file = f'{self.base_path}/cleaned_market_prices/dam_and_idm/2023_dam_idm_price.csv'
        ...
        dch_file = os.path.join(dc_path, 'DCH/2023_dch_price.csv')
        dcl_file = os.path.join(dc_path, 'DCL/2023_dcl_price.csv')
