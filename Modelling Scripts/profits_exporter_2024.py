"""
BESS Profits Data Exporter (2024 Base Case)
...
class BESSProfitsExporter2024:
    ...
    def calculate_idm_profits(self, power_mw, energy_mwh):
        """Calculate IDM daily profits for 2024 using actual IDM prices"""
    ...
    def calculate_dc_profits(self, power_mw):
        """Calculate DC daily profits for 2024 using full capacity"""
    ...
    def export_baseline_profits(self, config):
        ...
        filename = f'2024_ST profit (config {config_id}).csv'
...
def main():
    ...
    exporter = BESSProfitsExporter2024(base_path)
