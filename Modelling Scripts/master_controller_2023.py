"""
Master Workflow Controller for BESS Arbitrage Optimization (2023 Base Case)
Integrates all stages of the two-stage portfolio optimization process
Base case: 2023, Scenario years: 2024, 2022, 2021
"""
...
class BESSWorkflowController2023:
    ...
    def predict_idm_prices(self):
        """Generate IDM price predictions for 2024, 2022, 2021 using their actual DAM prices"""
    ...
    def calculate_dc_profits(self, dam_weight, power_mw):
        """Calculate DC profits using 2023 prices and remaining capacity"""
    ...
    def run_updated_stage(self, power_mw, energy_mwh, dam_weight):
        ...
        # Generate IDM predictions for 2024, 2022, 2021
    ...
    def run_all_configurations(self):
        ...
        print("Starting BESS Portfolio Optimization Workflow (2023 Base Case)")
        print("=" * 60)
        ...
        if all_results:
            ...
            output_file = os.path.join(output_dir, 'consolidated_bess_results_2023_base.csv')
...
def main():
    ...
    controller = BESSWorkflowController2023(base_path)
