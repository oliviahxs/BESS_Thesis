"""
BESS Profits Data Exporter (2022 Base Case)
...
class BESSProfitsExporter2022:
    ...
    def calculate_idm_profits(self, power_mw, energy_mwh):
        """Calculate IDM daily profits for 2022 using actual IDM prices"""
    ...
    def calculate_dc_profits(self, power_mw):
        """Calculate DC daily profits for 2022 using full capacity"""
    ...
    def export_baseline_profits(self, config):
        ...
        filename = f'2022_ST profit (config {config_id}).csv'
    ...
    def export_all_configurations(self):
        ...
        print("Starting BESS Profits Statistics Export (2022 Data)")
        print("=" * 55)
        ...
        if all_stats:
            ...
            stats_file = os.path.join(output_dir, 'profits_statistics_summary_2022.csv')
...
def main():
    ...
    exporter = BESSProfitsExporter2022(base_path)
