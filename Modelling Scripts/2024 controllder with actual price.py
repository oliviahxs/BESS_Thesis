...
class BESSWorkflowController:
    ...
    def predict_idm_prices(self):
        ...
        for year in [2021, 2022, 2023]:
            ...
            for t in range(1, len(actual_dam)):
                predicted_idm[t] = 0.854 * actual_dam[t] + 8.21
            
            df['Predicted_IDM'] = predicted_idm
            
            # Save the results for this year
            output_file = f'{self.base_path}/FINAL MODEL/Results/new_predicted_idm_price{year}_from_{year}dam.csv'
    ...
    def calculate_idm_profits(self, year, power_mw, energy_mwh, dam_weight):
        ...
        predicted_file = f'{self.base_path}/FINAL MODEL/Results/new_predicted_idm_price{year}_from_{year}dam.csv'
    ...
    def run_all_configurations(self):
        ...
        if all_results:
            ...
            output_file = os.path.join(output_dir, 'Simp_linear_2024_results.csv')
