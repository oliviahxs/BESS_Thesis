...
class BESSWorkflowController:
    ...
    def markowitz_optimization(self, mean_returns, cov_matrix, risk_aversion=4):
    ...
    def run_all_configurations_dc_price_levels(self):
        ...
        if all_results:
            output_dir = f'{self.base_path}/Fig_13&15-18_Model Outputs'
            os.makedirs(output_dir, exist_ok=True)
            
            results_df = pd.DataFrame(all_results)
            output_file = os.path.join(output_dir, 'Fig_13,15,16_data.csv')
